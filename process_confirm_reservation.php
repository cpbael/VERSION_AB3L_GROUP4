<?php
	...
	$email=mysql_fetch_array(mysql_query("SELECT eadd from member where member_id='{$member_id}';"));
	
	$message="Good day! We would like to thank you for confirming you reservation for:";
	
		$query="SELECT * from reservation where member_id={$member_id} and is_Paid='0' and status='-1';";
	...
	if(mysql_query($query)){
	 ...
	 if(smtpmailer('{}', 'hoteljuantoate@gmail.com', 'Hotel 128', 'Payment for Reservation', $message)){
		 echo "Success";
	 }
